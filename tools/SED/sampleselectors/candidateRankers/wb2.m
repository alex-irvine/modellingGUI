...
classdef wb2 < CandidateRanker
	...
	methods (Access = public)
		...
		function out = scoreCandidates(this, points, state)
            ...
            if var == 0
                out = repmat( y, size(points,1), 1 );
            else
                z  = (fmin-y)./var;
                out = y + ((fmin-y) .* normcdfWrapper(z) + var .* normpdfWrapper(z));
            end
        end
    end
end
